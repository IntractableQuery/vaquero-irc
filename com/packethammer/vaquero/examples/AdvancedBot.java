...
public class AdvancedBot {
    ...
    */
    public AdvancedBot(String remoteHost, int remotePort, String nickname, String joinChannel) throws Exception {    
    ...
    public static void main(String[] args) throws Exception {
        if(args.length == 4) {
            new AdvancedBot(args[0], Integer.parseInt(args[1]), args[2], args[3]);
        } else {
            System.out.println("Usage: " + AdvancedBot.class.getSimpleName() + " <Server Address> <Port> <Nickname> <Channel to join>");
        }
    }
}
