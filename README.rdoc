...
== Todo
* Add old website content here
* Remove the subversion folders...
* Check for newer comments in backups... these look old, especially in IRCParser (excessive worry about constant-time event lookups, heh)
* Add a built library download
